...
MLIL_GET_VARS = [MediumLevelILOperation.MLIL_VAR_SSA, MediumLevelILOperation.MLIL_VAR_SSA_FIELD, MediumLevelILOperation.MLIL_SX, MediumLevelILOperation.MLIL_ZX, MediumLevelILOperation.MLIL_ADD]

MLIL_SET_VARS = [MediumLevelILOperation.MLIL_SET_VAR_SSA, MediumLevelILOperation.MLIL_SET_VAR_SSA_FIELD]

MLIL_VARS = [MediumLevelILOperation.MLIL_VAR_SSA, MediumLevelILOperation.MLIL_VAR_SSA_FIELD]

MLIL_MEM_WRITE = [MediumLevelILOperation.MLIL_VAR_SSA, MediumLevelILOperation.MLIL_VAR_SSA_FIELD, MediumLevelILOperation.MLIL_ADD, MediumLevelILOperation.MLIL_CONST, MediumLevelILOperation.MLIL_CONST_PTR]
